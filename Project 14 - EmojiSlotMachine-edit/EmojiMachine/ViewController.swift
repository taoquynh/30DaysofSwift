...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        goButton.layer.borderColor = #colorLiteral(red: 0.9311985118, green: 1, blue: 0.9711410155, alpha: 0.5)
    ...
    @IBAction func amazingButtonDidTouch(_ sender: UIButton) {
        ...
        sender.setTitle(amazingFlag ? "":"", for: .normal)
    }
    @IBAction func goButtoDidTouch(_ sender: AnyObject) {
        ...
        if amazingFlag {
            ...
            index1 = Int(arc4random()) % 10 + 3
            index2 = Int(arc4random()) % 10 + 3
            index3 = Int(arc4random()) % 10 + 3
            
            print("not amazingFlag")
            print(index1, index2, index3)
        }
